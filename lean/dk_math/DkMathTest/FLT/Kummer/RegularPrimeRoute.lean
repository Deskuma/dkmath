...
-- `sorry` (isolated non-first-case reduction kernel)
#print axioms DkMath.FLT.cyclotomicPrincipalizationNonFirstCaseReduction_of_classGroupPTorsionFree -- uses sorry
-- `sorry` only via the isolated non-first-case reduction kernel
#print axioms DkMath.FLT.cyclotomicPrincipalizationNonFirstCaseDescentExistence_of_classGroupPTorsionFree -- uses sorry via non-first-case reduction target
