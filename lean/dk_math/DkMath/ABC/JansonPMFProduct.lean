...
import DkMath.ABC.JansonFiniteUniform

#print "file: DkMath.ABC.JansonPMFProduct"

set_option linter.style.longLine false
set_option linter.style.emptyLine false

/- Note:
※ `JansonBasic.lean` から昇格した Janson model / PMF product / expectation helper owner。
  finite-uniform wrapper は `DkMath.ABC.JansonFiniteUniform` に分離済み。
-/
