...
| Big (=m^3) | One-candidate | Two-candidate | 新規 `ΔBody` | 備考 |
|---:|---:|---:|---|---|
| 27  | 4  | 3  | {1, 6, 11} | 初期核の立ち上がり |
| 64  | 5  | 6  | {10} | Two 島が One を上回る開始点 |
| 125 | 6  | 9  | {34} | 長距離切替間隔が追加 |
| 216 | 7  | 14 | {27} | One/Twо 分岐の再現が明瞭化 |
| 343 | 8  | 20 | {2} | 近接切替の新型が出現 |
| 512 | 9  | 26 | {44} | 最大級の切替間隔が出現 |
| 729 | 10 | 34 | ∅ | `ΔBody` 候補集合はこの時点で飽和 |
