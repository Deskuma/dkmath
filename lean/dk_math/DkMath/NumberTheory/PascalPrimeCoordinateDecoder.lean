...
This is a finite, prime-indexed support decoder.  The `Nat.Prime` predicate is
an index type supplied to the construction; this module does not derive a
primality test from Pascal congruences, nor does it introduce prime-power or
von Mangoldt multiplicities.
-/
